    ...
    <div className={`bg-sb-surface-1 border w-[240px] rounded relative group overflow-hidden transition-colors ${borderClass}`}>
      ...
      <div className="px-4 pt-3 pb-3">
        ...
        {isEditing ? (
          ...
          <div
            className="text-sb-text-primary whitespace-pre-wrap cursor-text min-h-[1.5rem] font-mono text-[13px] leading-[1.65] line-clamp-3"
        ...
        {loadingStatus === "analyzing" ? (
          ...
          <p className="mt-2 text-[9px] text-sb-accent opacity-50">
